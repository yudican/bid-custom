...
const ProductMasterList = () => {
  ...
  const handleFilter = (data) => {
    setFilterData(data)
    loadData(`/api/product-management/product`, 10, data)
  }
  ...
  return (
    <Layout rightContent={rightContent} title="List Product Master">
      ...
      <Table
        ...
        columns={[
          ...
          },
          {
            ...
            width: 100,
            render: (text, record) => {
              if (inArray(getItem("role"), ["warehouse"])) {
                return (
                  <Dropdown.Button
                    style={{
                      left: -16,
                ...
                <Dropdown.Button
                  ...
                  overlay={
                    <Menu itemIcon={<RightOutlined />}>
                      <Menu.Item
                        icon={<FileAddOutlined />}
                        onClick={() => navigate(`stock-allocation/${text.id}`)}
                        disabled={record.final_stock < 1}
                      >
                        Stock Allocation
                      </Menu.Item>
