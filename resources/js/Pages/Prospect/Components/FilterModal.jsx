...
import { DatePicker, Modal, Segmented, Select } from "antd"
        ...
        <div>
          ...
          <div className="mb-2">
            ...
            <div>
              <Segmented
                block
                options={["All", "0 Activity", "<5 Activity", ">5 Activity"]}
              />
            </div>
          </div>
          ...
          {/* <div>
            ...
            <Select
              allowClear
              className="w-full mb-2"
              placeholder="Select Status Print"
          ...
          {/* <div>
            ...
            <Select
              allowClear
              className="w-full mb-2"
              placeholder="Select Resi Sudah Diinput"
