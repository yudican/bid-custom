...
const GpCustomer = () => {
  ...
  const deleteData = (customer_id) => {
    axios
      .post(`${base_url}/api/gp-customer/delete/${customer_id}`, {
        _method: "DELETE",
      })
      .then((res) => {
  ...
  const handleChangePage = (page, pageSize = 10) => {
    loadData(`/api/gp-customer/list/?page=${page}`, pageSize);
  };
        ...
        return (
          <div className="flex justify-between items-center w-20">
            <GpCustomerForm
              ...
              update
              url={`${base_url}/api/gp-customer/update/${record.id}`}
            />
            <Popconfirm
    ...
    <Layout
      ...
      rightContent={
        <GpCustomerForm
          refetch={() => loadData()}
          parents={[]}
          url={`${base_url}/api/gp-customer/create`}
        />
      }
    >
      <Table
