...
const LogisticRateModal = ({ logisticId }) => {
  ...
  const loadData = (
    url = "/api/master/shipping-method/logistic/rates",
    perpage = 10,
  ...
  const handleChange = (page, pageSize = 10) => {
    loadData(
      `/api/master/shipping-method/logistic/rates/?page=${page}`,
      pageSize,
      {
        page,
      }
  ...
  const updateStatus = (record, field = "logistic_rate_status") => {
    axios
      .post(`/api/master/shipping-method/logistic/rates/update`, {
  ...
  const deleteLogistic = (logistic_id) => {
    axios
      .post(
        `/api/master/shipping-method/offline/logistic/rates/delete/${logistic_id}`,
        { _method: "DELETE" }
      )
      .then((res) => {
