            ...
            <div className="col-md-6">
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input your Qty Voucher!",
                  },
                ]}
              >
            ...
            <div className="col-md-6">
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input your Min Transaction!",
                  },
                ]}
              >
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input your Type Voucher!",
                  },
                ]}
              >
                <Select
                  allowClear
                  className="w-full"
                  placeholder="Select Type Voucher"
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input your Limit Usage!",
                  },
                ]}
              >
                ...
                rules={[
                  {
                    ...
                    message: "Please input Voucher Image!",
                  },
                ]}
              >
                <Upload
