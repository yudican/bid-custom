    ...
    <>
      ...
      >
        ...
        >
          <div className="card-body grid md:grid-cols-3 gap-4">
            ...
            <TableInformation title="Type Po" value={detail?.type_po} />
      ...
      <div className="card p-4">
        <Card
          title={
            <div>
              <span className="mr-4">Informasi Penerimaan Barang</span>
          ...
          extra={
            <div className="flex justify-end items-center">
              {canAcceptProduct && (
                <ModalPenerimaan
                  refetch={() => loadDetail()}
                  products={detail.items.filter((item) => item.is_master > 0)}
          ...
          <div>
            <div className="flex items-center md:col-start-1 md:col-end-3">
              ...
              <span className="font-light">
                Terapkan stok opname pada data purchase order ini
              </span>
            </div>
          </div>
          <div></div>
