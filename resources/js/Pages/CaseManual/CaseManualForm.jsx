            ...
            <div className="col-md-4">
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input your Source Case!",
                  },
                ]}
              >
                <Select placeholder="Select Source Case">
                  {sourceCase.map((item) => (
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input your Status Case!",
                  },
                ]}
              >
                <Input disabled />
            ...
            <div className="col-md-4">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input your Type Case!",
                  },
                ]}
              >
                <Select placeholder="Select Type Case">
                  {typeCase.map((item) => (
                    <Select.Option value={item.id} key={item.id}>
                      {item.type_name}
                    </Select.Option>
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input your Category Case!",
                  },
                ]}
              >
                <Select placeholder="Select Category Case">
            ...
            <div className="col-md-4">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input your Priority Case!",
                  },
                ]}
              >
                <Select placeholder="Select Priority Case">
              ...
              >
                <Select placeholder="Select Status Case">
                  {statusCase.map((item) => (
                    <Select.Option value={item.id} key={item.id}>
                      {item.status_name}
                    </Select.Option>
