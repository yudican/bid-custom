...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <!-- Fonts and icons -->
    <script src="{{
        asset('assets/js/plugin/webfont/webfont.min.js')
      }}"></script>
    <script>
      WebFont.load({
  ...
  <body class="font-sans antialiased" style="background-color: #fff">
        ...
        <div class="nav-top">
          ...
          <nav class="navbar navbar-light" data-background-color="white">
            ...
            <a class="navbar-brand" href="#">
              {{--
              <img
                src="https://daftar-agen.com/img/logo-light.png"
                height="30"
                alt=""
              />
              --}} {{--
              <img
                src="https://media-exp1.licdn.com/dms/image/C560BAQG9nKjKqaZHbQ/company-logo_200_200/0/1662637215084?e=2147483647&v=beta&t=OxVksn_sADSbiS1K1PDtfi74Of9NbImrzu6rO-nYRio"
                width="60"
                height="60"
                alt="logo aimi capital"
              />
              --}}
            </a>
          </nav>
    ...
    <!-- jQuery UI -->
    <script src="{{
        asset('assets/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js')
      }}"></script>
    <script src="{{
        asset(
    ...
    <!-- jQuery Scrollbar -->
    <script src="{{
        asset('assets/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js')
      }}"></script>
