...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body class="login">
    <div class="wrapper wrapper-login wrapper-login-full p-0">
      <div
        class="login-aside w-50"
        style="
          background-image: url('https://aimidev.s3.us-west-004.backblazeb2.com/upload/user/KNFAitWreVY1ClnUNH4jOonc0PlljhKtiEwKyjNA.svg');
      ...
      >
        ...
        <p class="subtitle text-white op-7">
          Hari Yang Hebat Untuk Orang Yang Kuat.
        </p>
        --}}
      </div>
      <div
