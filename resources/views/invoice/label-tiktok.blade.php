...
<body>
  <table width="100%">
    <tr>
      <td width="100%"><img src="{{asset('assets/img/jnt.png')}}" style="height:80px;" alt=""></td>
      <td width="100%">{{$barcodeText}}</td>
    </tr>
    <tr>
      <td width="80%"></td>
  ...
  <table width="100%;">
    <tr>
      <td align="center"><img src="data:image/png;base64,{{ base64_encode($barcode) }}" style="height:90px;" alt="">
        <p>{{$barcodeText}}</p>
      </td>
    </tr>
  </table>
  ...
  <table width="100%;">
    ...
    <tr>
      <td>
        ...
        <strong>{{@$data->buyer_phone}}</strong><br />
        <strong>{{@$data->full_address}}</strong><br>
      </td>
    </tr>
  </table>
...
-->
  <table width="100%" style="margin-top:20px;border-bottom: 1px solid #000;">
    ...
    <tr>
      ...
      <td align="center">
        <strong>
          Rp {{number_format(@$item->sku_original_price * @$item->quantity)}}
        </strong>
      </td>
    </tr>
    @endforeach
