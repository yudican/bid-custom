            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        ...
                        @else
                        @if (in_array(auth()->user()->role->role_type, ['cs', 'leadcs', 'superadmin', 'adminsales']))
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        @if (!$update_mode && in_array(auth()->user()->role->role_type, ['adminsales', 'superadmin', 'leadsales', 'cs']))
                        ...
                        @elseif ($update_mode && $status == 0 && in_array(auth()->user()->role->role_type, ['adminsales', 'superadmin', 'leadsales', 'warehouse']))
                        <div class="form-group">
                        ...
                        @elseif ($update_mode && $status == 1 && in_array(auth()->user()->role->role_type, ['adminsales', 'superadmin', 'leadsales', 'warehouse']))
                        <div class="form-group">
                            <button class="btn btn-danger pull-right"
