                                                ...
                                                <tbody>
                                                    ...
                                                    @for ($index = 0; $index < count($inputs); $index++) <tr>
                                                        ...
                                                        <td class="p-0">
                                                            <div class="d-flex  align-items-center flex-row mt-2">
                                                                <div class="input-group input-spinner mr-3">
                                                                    ...
                                                                    <button class="btn btn-light btn-xs" type="button" wire:click="getPrice({{$product_id[$index]}},{{$index}},'min')" {{(in_array(auth()->user()->role->role_type, ['adminsales', 'superadmin', 'leadsales']))?'disabled':''}}> <i
                                                                            class="fas fa-minus"></i> </button>

                                                                    <button class="btn btn-light btn-xs" type="button"> {{$qty[$index]}} </button>

                                                                    <button class="btn btn-light btn-xs" type="button" wire:click="getPrice({{$product_id[$index]}},{{$index}},'plus')" {{(in_array(auth()->user()->role->role_type, ['adminsales', 'superadmin', 'leadsales']))?'disabled':''}}> <i
                                                        ...
                                                        <td class="p-0">
                                                            ...
                                                            <input id="price.{{$index}}" value="" name="price.{{$index}}" wire:model="price.{{$index}}" type="text" class="form-control" {{(auth()->user()->role->role_type == 'adminsales' || auth()->user()->role->role_type ==
                                                            'superadmin')?'readonly':''}}>
