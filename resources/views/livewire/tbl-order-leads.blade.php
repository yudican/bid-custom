<div class="page-inner">
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    @if (in_array(auth()->user()->role->role_type, ['adminsales', 'superadmin', 'leadsales']))
                    <div class="row">
                        <div class="col-md-3">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content mt-2 mb-3" id="pills-tabContent">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" style="color: #13854E;font-weight: bold;">{{$lead->title}}
                                        <div class="pull-right">
                                            <button class="btn btn-primary btn-sm" style="background: white !important;color: #003E8B;font-size: 10pt;font-family: 'Poppins', sans-serif;" wire:click="getDataLeadActivityById('{{ $lead->uid_lead }}')"><i class="fa fa-eye"></i> Detail Activity</button>
                                            ...
                                            <table width="100%">
                                                <thead class="thead-lightss">
                                                    <tr>
                                                        ...
                                                        @if (auth()->user()->role->role_type != 'adminsales' && auth()->user()->role->role_type != 'superadmin' && auth()->user()->role->role_type != 'leadsales')
                                                    ...
                                                    @for ($index = 0; $index < count($inputs); $index++) <tr>
                                                        <td class="p-0">
                                                            <div class="form-group {{$errors->has('product_id.'.$index) ? 'has-error has-feedback' : '' }} w-100">
                                                                <select name="product_id.{{$index}}" wire:model="product_id.{{$index}}" wire:change="getPrice($event.target.value,{{$index}})" class="form-control" {{(in_array(auth()->user()->role->role_type, ['adminsales', 'superadmin',
                                                        ...
                                                        <td class="p-0">
                                                            <div class="d-flex  align-items-center flex-row mt-2">
                                                                <div class="input-group input-spinner mr-3">
                                                                    ...
                                                                    <button class="btn btn-light btn-xs" type="button" wire:click="getPrice({{$product_id[$index]}},{{$index}},'min')" {{(in_array(auth()->user()->role->role_type, ['adminsales', 'superadmin', 'leadsales', 'sales']))?'disabled':''}}> <i
                                                                            class="fas fa-minus"></i> </button>

                                                                    <button class="btn btn-light btn-xs" type="button"> {{$qty[$index]}} </button>

                                                                    <button class="btn btn-light btn-xs" type="button" wire:click="getPrice({{$product_id[$index]}},{{$index}},'plus')" {{(in_array(auth()->user()->role->role_type, ['adminsales', 'superadmin', 'leadsales', 'sales']))?'disabled':''}}> <i
                                                                            class="fas fa-plus"></i> </button>
                                                                </div> <!-- input-group.// -->
                                                            </div> <!-- input-group.// -->
                                                        </td>
                                                        <td class="p-2">
                                                            <select name="discount.{{$index}}" wire:model="discount.{{$index}}" class="form-control" {{(in_array(auth()->user()->role->role_type, ['adminsales', 'superadmin', 'leadsales']))?'disabled':''}}>
                                                        ...
                                                        @php $ppn += @$tax[$index]->tax_percentage; @endphp
                                                            <select name="tax.{{$index}}" wire:model="tax.{{$index}}" class="form-control" {{(in_array(auth()->user()->role->role_type, ['adminsales', 'superadmin', 'leadsales']))?'disabled':''}}>
                                                        ...
                                                        @if ((auth()->user()->role->role_type != 'adminsales' && auth()->user()->role->role_type != 'superadmin' && auth()->user()->role->role_type != 'leadsales') && ($lead->status != 1))
                                                        <td class="p-0">
                                                            @if ($index > 0)
                        ...
                        <div class="tab-pane fade  active show" id="pills-transactive" role="tabpanel" aria-labelledby="pills-transactive-tab">
                                ...
                                <div class="card-header">
                                    <h4 class="card-title">Detail Order
                                        <div class="pull-right">
                                            ...
                                            <button class="btn btn-primary btn-sm" style="background: white !important;color: #003E8B;font-size: 10pt;font-family: 'Poppins', sans-serif;" wire:click="getDataLeadNegotiationById('{{ $lead->uid_lead }}')"><i class="fa fa-eye"></i> Detail
                                                Negotiation</button>
                                            &nbsp;
                                            ...
                                            <table width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    @for ($index = 0; $index < count($inputs); $index++) <tr>
                                                        ...
                                                        <td class="p-0">
                                                            <div class="d-flex  align-items-center flex-row mt-2">
                                                                <div class="input-group input-spinner mr-3">
                                                                    ...
                                                                    <button class="btn btn-light btn-xs" type="button" wire:click="getPrice({{$product_id[$index]}},{{$index}},'min')" {{(in_array(auth()->user()->role->role_type, ['adminsales', 'superadmin', 'leadsales','collector']))?'disabled':''}}>
                                                                        <i class="fas fa-minus"></i> </button>

                                                                    <button class="btn btn-light btn-xs" type="button"> {{$qty[$index]}} </button>

                                                                    <button class="btn btn-light btn-xs" type="button" wire:click="getPrice({{$product_id[$index]}},{{$index}},'plus')" {{(in_array(auth()->user()->role->role_type, ['adminsales', 'superadmin',
                                                        ...
                                                        <td class="p-0">
                                                            @php $total += $price[$index]; $item += $index; @endphp
                                                            <input id="price.{{$index}}" value="" name="price.{{$index}}" wire:model="price.{{$index}}" type="text" class="form-control" {{in_array(auth()->user()->role->role_type, ['adminsales', 'superadmin', 'leadsales',
                                                            'collector'])?'readonly':''}}>
                            ...
                            @if (in_array(auth()->user()->role->role_type, ['collector','adminsales','leadsales','superadmin']))
                            <div class="card">
                                <div class="card-header">
                            ...
                            @if (in_array(auth()->user()->role->role_type, ['superadmin','adminsales','leadsales']))
                            <div class="card">
                                <div class="card-header">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            @elseif ($lead->status_pengiriman == '1' && auth()->user()->role->role_type == 'warehouse')
                                            <div class="row">
                                        ...
                                        <table width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                @for ($index = 0; $index < count($inputs); $index++) <tr>
                                                    ...
                                                    <td class="p-0">
                                                        @php $total += $price[$index]; $item += $index; @endphp
                                                        <input id="price.{{$index}}" value="" name="price.{{$index}}" wire:model="price.{{$index}}" type="text" class="form-control" {{(auth()->user()->role->role_type == 'adminsales' || auth()->user()->role->role_type == 'superadmin')?'readonly':''}}>
