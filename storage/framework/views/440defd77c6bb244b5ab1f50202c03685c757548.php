                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        <li class="nav-item dropdown hidden-caret submenu d-flex">
                            ...
                            } elseif ($_instance->childHasBeenRendered('ZdEGSUi')) {
                                $componentId = $_instance->getRenderedChildComponentId('ZdEGSUi');
                                $componentTag = $_instance->getRenderedChildComponentTagName('ZdEGSUi');
                                $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                $_instance->preserveRenderedChild('ZdEGSUi');
                            } else {
                                $response = \Livewire\Livewire::mount('components.switch-account');
                                $html = $response->html();
                                $_instance->logRenderedChild('ZdEGSUi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                            }
                            echo $html;
                            ?>
                            <?php
                            ...
                            } elseif ($_instance->childHasBeenRendered('cZEt3Bv')) {
                                $componentId = $_instance->getRenderedChildComponentId('cZEt3Bv');
                                $componentTag = $_instance->getRenderedChildComponentTagName('cZEt3Bv');
                                $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                $_instance->preserveRenderedChild('cZEt3Bv');
                            } else {
                                $response = \Livewire\Livewire::mount('components.toggle-dark-mode');
                                $html = $response->html();
                                $_instance->logRenderedChild('cZEt3Bv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                            }
                            echo $html;
                            ?>
                            <?php if (in_array($role->role_type, ['mitra', 'subagent'])) : ?>
                                ...
                                } elseif ($_instance->childHasBeenRendered('h2dKLgH')) {
                                    $componentId = $_instance->getRenderedChildComponentId('h2dKLgH');
                                    $componentTag = $_instance->getRenderedChildComponentTagName('h2dKLgH');
                                    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                    $_instance->preserveRenderedChild('h2dKLgH');
                                } else {
                                    $response = \Livewire\Livewire::mount('components.cart-component');
                                    $html = $response->html();
                                    $_instance->logRenderedChild('h2dKLgH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                                }
                                echo $html;
                                ?>
                            <?php endif; ?>
                            ...
                            } elseif ($_instance->childHasBeenRendered('7GmISAv')) {
                                $componentId = $_instance->getRenderedChildComponentId('7GmISAv');
                                $componentTag = $_instance->getRenderedChildComponentTagName('7GmISAv');
                                $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                $_instance->preserveRenderedChild('7GmISAv');
                            } else {
                                $response = \Livewire\Livewire::mount('components.notification-badge');
                                $html = $response->html();
                                $_instance->logRenderedChild('7GmISAv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                            }
                            echo $html;
                            ?>
...
</html><?php /**PATH /Users/yudicandra/Documents/Projects/Laravel/laravel/server/resources/views/layouts/app.blade.php ENDPATH**/ ?>