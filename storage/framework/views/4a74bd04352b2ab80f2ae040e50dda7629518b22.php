                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        <li class="nav-item dropdown hidden-caret submenu d-flex">
                            ...
                            } elseif ($_instance->childHasBeenRendered('hsJXHQL')) {
                                $componentId = $_instance->getRenderedChildComponentId('hsJXHQL');
                                $componentTag = $_instance->getRenderedChildComponentTagName('hsJXHQL');
                                $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                $_instance->preserveRenderedChild('hsJXHQL');
                            } else {
                                $response = \Livewire\Livewire::mount('components.switch-account');
                                $html = $response->html();
                                $_instance->logRenderedChild('hsJXHQL', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                            }
                            echo $html;
                            ?>
                            <?php
                            ...
                            } elseif ($_instance->childHasBeenRendered('pfSzjW4')) {
                                $componentId = $_instance->getRenderedChildComponentId('pfSzjW4');
                                $componentTag = $_instance->getRenderedChildComponentTagName('pfSzjW4');
                                $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                $_instance->preserveRenderedChild('pfSzjW4');
                            } else {
                                $response = \Livewire\Livewire::mount('components.toggle-dark-mode');
                                $html = $response->html();
                                $_instance->logRenderedChild('pfSzjW4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                            }
                            echo $html;
                            ?>
                            <?php if (in_array($role->role_type, ['mitra', 'subagent'])) : ?>
                                ...
                                } elseif ($_instance->childHasBeenRendered('H3RIFIH')) {
                                    $componentId = $_instance->getRenderedChildComponentId('H3RIFIH');
                                    $componentTag = $_instance->getRenderedChildComponentTagName('H3RIFIH');
                                    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                    $_instance->preserveRenderedChild('H3RIFIH');
                                } else {
                                    $response = \Livewire\Livewire::mount('components.cart-component');
                                    $html = $response->html();
                                    $_instance->logRenderedChild('H3RIFIH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                                }
                                echo $html;
                                ?>
                            <?php endif; ?>
                            ...
                            } elseif ($_instance->childHasBeenRendered('5ylOIVd')) {
                                $componentId = $_instance->getRenderedChildComponentId('5ylOIVd');
                                $componentTag = $_instance->getRenderedChildComponentTagName('5ylOIVd');
                                $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                $_instance->preserveRenderedChild('5ylOIVd');
                            } else {
                                $response = \Livewire\Livewire::mount('components.notification-badge');
                                $html = $response->html();
                                $_instance->logRenderedChild('5ylOIVd', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                            }
                            echo $html;
                            ?>
...
</html><?php /**PATH /home/server/resources/views/layouts/app.blade.php ENDPATH**/ ?>