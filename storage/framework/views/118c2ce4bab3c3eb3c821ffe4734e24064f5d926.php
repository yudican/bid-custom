...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('assets/img/bidflowlogo.jpg')); ?>" type="image/x-icon" />
    ...
    <script>
        WebFont.load({
        			...
        			custom: {"families":["Flaticon", "Font Awesome 5 Solid", "Font Awesome 5 Regular", "Font Awesome 5 Brands", "simple-line-icons"], urls: [`<?php echo e(request()->getSchemeAndHttpHost()); ?>/assets/css/fonts.min.css`]},
        			active: function() {
...
} elseif ($_instance->childHasBeenRendered('Vu360AO')) {
    $componentId = $_instance->getRenderedChildComponentId('Vu360AO');
    $componentTag = $_instance->getRenderedChildComponentTagName('Vu360AO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Vu360AO');
} else {
    $response = \Livewire\Livewire::mount('components.switch-account');
    $html = $response->html();
    $_instance->logRenderedChild('Vu360AO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php
...
} elseif ($_instance->childHasBeenRendered('tURAVET')) {
    $componentId = $_instance->getRenderedChildComponentId('tURAVET');
    $componentTag = $_instance->getRenderedChildComponentTagName('tURAVET');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tURAVET');
} else {
    $response = \Livewire\Livewire::mount('components.toggle-dark-mode');
    $html = $response->html();
    $_instance->logRenderedChild('tURAVET', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('Z0CQgMf')) {
    $componentId = $_instance->getRenderedChildComponentId('Z0CQgMf');
    $componentTag = $_instance->getRenderedChildComponentTagName('Z0CQgMf');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Z0CQgMf');
} else {
    $response = \Livewire\Livewire::mount('components.cart-component');
    $html = $response->html();
    $_instance->logRenderedChild('Z0CQgMf', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('oywDFYs')) {
    $componentId = $_instance->getRenderedChildComponentId('oywDFYs');
    $componentTag = $_instance->getRenderedChildComponentTagName('oywDFYs');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('oywDFYs');
} else {
    $response = \Livewire\Livewire::mount('components.notification-badge');
    $html = $response->html();
    $_instance->logRenderedChild('oywDFYs', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    ...
                                    <div class="scroll-wrapper notif-scroll scrollbar-outer" style="position: relative;">
                                        <div class="notif-scroll scrollbar-outer scroll-content" style="height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 256px;">
                                            <div class="notif-center">
                                                <?php $__currentLoopData = $notification_user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="#">
                        ...
                        <div class="info">
                            <a href="<?php echo e(url('/profile')); ?>">
                                <span>
                                    ...
                                    <span class="user-level"><?php echo e(Auth::user()->role->role_name); ?>
...
</html><?php /**PATH /Users/yudicandra/Documents/Projects/aimigroup/aimi-crm-bidflow/server/resources/views/layouts/app.blade.php ENDPATH**/ ?>