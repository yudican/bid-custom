...
} elseif ($_instance->childHasBeenRendered('6mejRY2')) {
    $componentId = $_instance->getRenderedChildComponentId('6mejRY2');
    $componentTag = $_instance->getRenderedChildComponentTagName('6mejRY2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6mejRY2');
} else {
    $response = \Livewire\Livewire::mount('components.switch-account');
    $html = $response->html();
    $_instance->logRenderedChild('6mejRY2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php
...
} elseif ($_instance->childHasBeenRendered('Q8f1bLI')) {
    $componentId = $_instance->getRenderedChildComponentId('Q8f1bLI');
    $componentTag = $_instance->getRenderedChildComponentTagName('Q8f1bLI');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Q8f1bLI');
} else {
    $response = \Livewire\Livewire::mount('components.toggle-dark-mode');
    $html = $response->html();
    $_instance->logRenderedChild('Q8f1bLI', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('ShgHJ6A')) {
    $componentId = $_instance->getRenderedChildComponentId('ShgHJ6A');
    $componentTag = $_instance->getRenderedChildComponentTagName('ShgHJ6A');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ShgHJ6A');
} else {
    $response = \Livewire\Livewire::mount('components.cart-component');
    $html = $response->html();
    $_instance->logRenderedChild('ShgHJ6A', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('745l9ug')) {
    $componentId = $_instance->getRenderedChildComponentId('745l9ug');
    $componentTag = $_instance->getRenderedChildComponentTagName('745l9ug');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('745l9ug');
} else {
    $response = \Livewire\Livewire::mount('components.notification-badge');
    $html = $response->html();
    $_instance->logRenderedChild('745l9ug', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH /Users/yudicandra/Documents/Projects/aimigroup/fis-momsy/server/resources/views/layouts/app.blade.php ENDPATH**/ ?>