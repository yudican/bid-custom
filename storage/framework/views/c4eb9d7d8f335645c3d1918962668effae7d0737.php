...
} elseif ($_instance->childHasBeenRendered('BQWfKQ1')) {
    $componentId = $_instance->getRenderedChildComponentId('BQWfKQ1');
    $componentTag = $_instance->getRenderedChildComponentTagName('BQWfKQ1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BQWfKQ1');
} else {
    $response = \Livewire\Livewire::mount('components.switch-account');
    $html = $response->html();
    $_instance->logRenderedChild('BQWfKQ1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php
...
} elseif ($_instance->childHasBeenRendered('qfc4B0V')) {
    $componentId = $_instance->getRenderedChildComponentId('qfc4B0V');
    $componentTag = $_instance->getRenderedChildComponentTagName('qfc4B0V');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qfc4B0V');
} else {
    $response = \Livewire\Livewire::mount('components.toggle-dark-mode');
    $html = $response->html();
    $_instance->logRenderedChild('qfc4B0V', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('q4OMVHf')) {
    $componentId = $_instance->getRenderedChildComponentId('q4OMVHf');
    $componentTag = $_instance->getRenderedChildComponentTagName('q4OMVHf');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('q4OMVHf');
} else {
    $response = \Livewire\Livewire::mount('components.cart-component');
    $html = $response->html();
    $_instance->logRenderedChild('q4OMVHf', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('cQCNMqT')) {
    $componentId = $_instance->getRenderedChildComponentId('cQCNMqT');
    $componentTag = $_instance->getRenderedChildComponentTagName('cQCNMqT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cQCNMqT');
} else {
    $response = \Livewire\Livewire::mount('components.notification-badge');
    $html = $response->html();
    $_instance->logRenderedChild('cQCNMqT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH /Applications/MAMP/htdocs/aimi-crm-bidflow/server/resources/views/layouts/app.blade.php ENDPATH**/ ?>