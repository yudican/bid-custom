...
} elseif ($_instance->childHasBeenRendered('OqD1zJp')) {
    $componentId = $_instance->getRenderedChildComponentId('OqD1zJp');
    $componentTag = $_instance->getRenderedChildComponentTagName('OqD1zJp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OqD1zJp');
} else {
    $response = \Livewire\Livewire::mount('components.switch-account');
    $html = $response->html();
    $_instance->logRenderedChild('OqD1zJp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php
...
} elseif ($_instance->childHasBeenRendered('YWti2mc')) {
    $componentId = $_instance->getRenderedChildComponentId('YWti2mc');
    $componentTag = $_instance->getRenderedChildComponentTagName('YWti2mc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YWti2mc');
} else {
    $response = \Livewire\Livewire::mount('components.toggle-dark-mode');
    $html = $response->html();
    $_instance->logRenderedChild('YWti2mc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('Q3kpN8r')) {
    $componentId = $_instance->getRenderedChildComponentId('Q3kpN8r');
    $componentTag = $_instance->getRenderedChildComponentTagName('Q3kpN8r');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Q3kpN8r');
} else {
    $response = \Livewire\Livewire::mount('components.cart-component');
    $html = $response->html();
    $_instance->logRenderedChild('Q3kpN8r', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('KRy6FbB')) {
    $componentId = $_instance->getRenderedChildComponentId('KRy6FbB');
    $componentTag = $_instance->getRenderedChildComponentTagName('KRy6FbB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KRy6FbB');
} else {
    $response = \Livewire\Livewire::mount('components.notification-badge');
    $html = $response->html();
    $_instance->logRenderedChild('KRy6FbB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH /Applications/MAMP/htdocs/aimi-crm-momsy/server/resources/views/layouts/app.blade.php ENDPATH**/ ?>