...
<body>
  <table width="100%">
    <tr>
      ...
      <td width="100%"><?php echo e($data->tracking_number); ?></td>
    </tr>
    <tr>
      <td width="80%"></td>
  ...
  <table width="100%;">
    <tr>
      <td align="center"><img src="<?php echo e(asset('assets/img/barcode1.gif')); ?>" style="height:90px;" alt=""></td>
    </tr>
  </table>
  <hr>
  <table width="100%;">
...
</html><?php /**PATH /Applications/MAMP/htdocs/aimi-crm-momsy/server/resources/views/invoice/label-tiktok.blade.php ENDPATH**/ ?>