<div class="page-inner">
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-6">
            <div class="card h-80">
                <img class="card-img-top p-2 " src="<?php echo e(getImage($prod->image)); ?>" style="
                        height: 140px;
                        object-fit: contain;
                        display: block;
                        margin-left: auto;
                ...
                <div class="card-body">
                    ...
                    <span style="color: red">Rp
                        <?php echo e(number_format($prod->price['final_price'],0,2)); ?></span><br />
                    <span style="text-decoration: line-through; font-size: 12px">Rp
                        <?php echo e(number_format($prod->price['basic_price'],0,2)); ?></span><br />
                    <button class="btn btn-primary btn-sm" style="width: 100%" wire:click="add_cart('<?php echo e($prod->id); ?>')">
                        + Keranjang
                    </button>
                </div>
            </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php $__env->startPush('scripts'); ?>
...
</div><?php /**PATH /Applications/MAMP/htdocs/aimi-crm-momsy/server/resources/views/livewire/agent/product.blade.php ENDPATH**/ ?>