<div>
  <div <?php if(isset($ignore)): ?> wire:ignore <?php endif; ?> class="form-group <?php echo e($errors->has($name) ? 'has-error has-feedback' : ''); ?> w-100">
    <?php if(isset($label)): ?>
...
</div><?php /**PATH /Applications/MAMP/htdocs/laravel/server/resources/views/components/select.blade.php ENDPATH**/ ?>