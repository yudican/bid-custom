                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        <li class="nav-item dropdown hidden-caret submenu d-flex">
                            ...
                            } elseif ($_instance->childHasBeenRendered('QyzIX8E')) {
                                $componentId = $_instance->getRenderedChildComponentId('QyzIX8E');
                                $componentTag = $_instance->getRenderedChildComponentTagName('QyzIX8E');
                                $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                $_instance->preserveRenderedChild('QyzIX8E');
                            } else {
                                $response = \Livewire\Livewire::mount('components.switch-account');
                                $html = $response->html();
                                $_instance->logRenderedChild('QyzIX8E', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                            }
                            echo $html;
                            ?>
                            <?php
                            ...
                            } elseif ($_instance->childHasBeenRendered('gXNqhtp')) {
                                $componentId = $_instance->getRenderedChildComponentId('gXNqhtp');
                                $componentTag = $_instance->getRenderedChildComponentTagName('gXNqhtp');
                                $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                $_instance->preserveRenderedChild('gXNqhtp');
                            } else {
                                $response = \Livewire\Livewire::mount('components.toggle-dark-mode');
                                $html = $response->html();
                                $_instance->logRenderedChild('gXNqhtp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                            }
                            echo $html;
                            ?>
                            <?php if (in_array($role->role_type, ['mitra', 'subagent'])) : ?>
                                ...
                                } elseif ($_instance->childHasBeenRendered('2KgLRlH')) {
                                    $componentId = $_instance->getRenderedChildComponentId('2KgLRlH');
                                    $componentTag = $_instance->getRenderedChildComponentTagName('2KgLRlH');
                                    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                    $_instance->preserveRenderedChild('2KgLRlH');
                                } else {
                                    $response = \Livewire\Livewire::mount('components.cart-component');
                                    $html = $response->html();
                                    $_instance->logRenderedChild('2KgLRlH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                                }
                                echo $html;
                                ?>
                            <?php endif; ?>
                            ...
                            } elseif ($_instance->childHasBeenRendered('vy2EGPJ')) {
                                $componentId = $_instance->getRenderedChildComponentId('vy2EGPJ');
                                $componentTag = $_instance->getRenderedChildComponentTagName('vy2EGPJ');
                                $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                $_instance->preserveRenderedChild('vy2EGPJ');
                            } else {
                                $response = \Livewire\Livewire::mount('components.notification-badge');
                                $html = $response->html();
                                $_instance->logRenderedChild('vy2EGPJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                            }
                            echo $html;
                            ?>
...
</html><?php /**PATH C:\Users\ricor\OneDrive\Dokumen\project\laravel\laravel\server\resources\views/layouts/app.blade.php ENDPATH**/ ?>