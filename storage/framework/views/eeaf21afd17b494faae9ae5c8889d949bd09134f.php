...
} elseif ($_instance->childHasBeenRendered('XY8dPWf')) {
    $componentId = $_instance->getRenderedChildComponentId('XY8dPWf');
    $componentTag = $_instance->getRenderedChildComponentTagName('XY8dPWf');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XY8dPWf');
} else {
    $response = \Livewire\Livewire::mount('components.switch-account');
    $html = $response->html();
    $_instance->logRenderedChild('XY8dPWf', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php
...
} elseif ($_instance->childHasBeenRendered('0KOLd6a')) {
    $componentId = $_instance->getRenderedChildComponentId('0KOLd6a');
    $componentTag = $_instance->getRenderedChildComponentTagName('0KOLd6a');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0KOLd6a');
} else {
    $response = \Livewire\Livewire::mount('components.toggle-dark-mode');
    $html = $response->html();
    $_instance->logRenderedChild('0KOLd6a', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('7Nixfpu')) {
    $componentId = $_instance->getRenderedChildComponentId('7Nixfpu');
    $componentTag = $_instance->getRenderedChildComponentTagName('7Nixfpu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7Nixfpu');
} else {
    $response = \Livewire\Livewire::mount('components.cart-component');
    $html = $response->html();
    $_instance->logRenderedChild('7Nixfpu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('DNvvQMQ')) {
    $componentId = $_instance->getRenderedChildComponentId('DNvvQMQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('DNvvQMQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DNvvQMQ');
} else {
    $response = \Livewire\Livewire::mount('components.notification-badge');
    $html = $response->html();
    $_instance->logRenderedChild('DNvvQMQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH /Users/user/Documents/Projects/aimi-group/aimi-crm-bidflow/server/resources/views/layouts/app.blade.php ENDPATH**/ ?>