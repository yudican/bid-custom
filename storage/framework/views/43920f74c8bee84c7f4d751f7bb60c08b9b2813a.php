                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        <li class="nav-item dropdown hidden-caret submenu d-flex">
                            ...
                            } elseif ($_instance->childHasBeenRendered('h39ahCC')) {
                                $componentId = $_instance->getRenderedChildComponentId('h39ahCC');
                                $componentTag = $_instance->getRenderedChildComponentTagName('h39ahCC');
                                $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                $_instance->preserveRenderedChild('h39ahCC');
                            } else {
                                $response = \Livewire\Livewire::mount('components.switch-account');
                                $html = $response->html();
                                $_instance->logRenderedChild('h39ahCC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                            }
                            echo $html;
                            ?>
                            <?php
                            ...
                            } elseif ($_instance->childHasBeenRendered('QzjEIlG')) {
                                $componentId = $_instance->getRenderedChildComponentId('QzjEIlG');
                                $componentTag = $_instance->getRenderedChildComponentTagName('QzjEIlG');
                                $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                $_instance->preserveRenderedChild('QzjEIlG');
                            } else {
                                $response = \Livewire\Livewire::mount('components.toggle-dark-mode');
                                $html = $response->html();
                                $_instance->logRenderedChild('QzjEIlG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                            }
                            echo $html;
                            ?>
                            <?php if (in_array($role->role_type, ['mitra', 'subagent'])) : ?>
                                ...
                                } elseif ($_instance->childHasBeenRendered('VvP6ct8')) {
                                    $componentId = $_instance->getRenderedChildComponentId('VvP6ct8');
                                    $componentTag = $_instance->getRenderedChildComponentTagName('VvP6ct8');
                                    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                    $_instance->preserveRenderedChild('VvP6ct8');
                                } else {
                                    $response = \Livewire\Livewire::mount('components.cart-component');
                                    $html = $response->html();
                                    $_instance->logRenderedChild('VvP6ct8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                                }
                                echo $html;
                                ?>
                            <?php endif; ?>
                            ...
                            } elseif ($_instance->childHasBeenRendered('CkJJd2K')) {
                                $componentId = $_instance->getRenderedChildComponentId('CkJJd2K');
                                $componentTag = $_instance->getRenderedChildComponentTagName('CkJJd2K');
                                $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                $_instance->preserveRenderedChild('CkJJd2K');
                            } else {
                                $response = \Livewire\Livewire::mount('components.notification-badge');
                                $html = $response->html();
                                $_instance->logRenderedChild('CkJJd2K', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                            }
                            echo $html;
                            ?>
...
</html><?php /**PATH /Users/danyarkham/aimi-crm-momsy/server/resources/views/layouts/app.blade.php ENDPATH**/ ?>