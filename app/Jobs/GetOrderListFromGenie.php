...
class GetOrderListFromGenie implements ShouldQueue
{
    ...
    public function getOrderList($more = true, $cursorData = [])
    {
        ...
        //                 GetOrderDetailFromGenie::dispatch($order['orderId'], $success_total)->onQueue('send-notification');
        //             }
        ...
        //             if ($more) {
        //                 GetOrderListFromGenie::dispatch($responseJSON['data']['more'], $cursor)->onQueue('send-notification');
        //             }
        //         } else {
