...
class GPSubmissionQueue implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        //     $skuData = SkuMaster::where('sku', $sku)->first();
        ...
        //     GPSubmissionDetailQueue::dispatch($datas, $total_progress, count($temps), $keyData)->onQueue('send-notification');
        // }

        // GpSoSubmisionQueue::dispatch($temps, $headerGp, $detailGp, $current_list)->onQueue('send-notification');
