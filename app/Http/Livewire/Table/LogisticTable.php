...
class LogisticTable extends LivewireDatatable
{
    ...
    public function toggleStatus($logistic_id)
    {
        ...
        if ($logistic) {
            ...
            UpdateToggleLogistic::dispatch($logistic->logistic_original_id, $status)->onQueue('send-notification');
            $logistic->update([
            ...
            foreach ($logistic->logisticRates as $rate) {
                ...
                UpdateToggleLogistic::dispatch($rate->logistic_rate_original_id, $status, 'rates')->onQueue('send-notification');
            }
        }
        $this->refreshTable();
    }
