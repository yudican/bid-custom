...
class PurchaseOrderItem extends Model
{
    use HasFactory;
    protected $fillable = [
        'purchase_order_id', 'product_id', 'tax_id', 'qty', 'qty_diterima', 'uom', 'price', 'status', 'received_number', 'invoice_entry', 'notes', 'vendor_doc_number', 'confirm_by', 'invoice_date', 'due_date', 'is_allocated', 'uid_invoice', 'qty_alocation', 'ref', 'is_master'
    ];

    protected $appends = ['prices', 'subtotal', 'tax_amount', 'tax_percentage', 'total_amount', 'tax_product_received', 'subtotal_product_received', 'subtotal_qty_diterima', 'sku', 'u_of_m', 'type', 'product_name', 'confirm_by_name', 'tax_invoice', 'qty_can_allocated'];
