...
class OrderLead extends Model
{
    ...
    protected $fillable = ['uid_lead', 'title', 'contact', 'sales', 'customer_need', 'user_created', 'user_updated', 'payment_term', 'brand_id', 'status', 'order_number', 'invoice_number', 'reference_number', 'shipping_type', 'address_id', 'notes', 'courier', 'status_penagihan', 'status_pengiriman', 'status_invoice', 'due_date', 'warehouse_id', 'kode_unik', 'temp_kode_unik', 'ongkir', 'company_id', 'status_submit', 'print_status', 'resi_status'];

    protected $dates = [];
    protected $appends = ['amount', 'subtotal', 'tax_amount', 'discount_amount', 'contact_name', 'sales_name', 'payment_term_name', 'created_by_name', 'selected_address', 'amount_billing_approved', 'amount_deposite', 'contact_uid', 'warehouse_name'];
    ...
    {
        return $this->hasMany(OrderDeposit::class, 'uid_lead', 'uid_lead')->where('order_type', 'lead')->where('contact', $this->contact);
    }
    ...
    {
        return $this->hasOne(OrderShipping::class, 'uid_lead', 'uid_lead')->where('order_type', 'lead');
    }
