...
class LeadMaster extends Model
{
    ...
    protected $fillable = ['title', 'uid_lead', 'contact', 'sales', 'lead_type', 'status', 'approval_notes', 'brand_id', 'customer_need',  'is_negotiation', 'nego_value', 'status_negotiation', 'user_created', 'warehouse_id', 'payment_term', 'type_customer', 'company_id'];

    protected $appends = ['contact_name', 'contact_name_only', 'sales_name', 'created_by_name', 'brand_name', 'status_name', 'brand_ids', 'total_negotiation', 'margin_total', 'subtotal', 'tax_amount', 'discount_amount', 'amount', 'created_on', 'company_name', 'warehouse_name'];
